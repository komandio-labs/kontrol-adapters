...
6. Build exactly one local package:
   ...
   ```powershell
   python scripts/kontrol_adapters.py pack --adapter spaceengineers2 --version 0.1.0-beta.1 --output artifacts/kontrol-adapter-spaceengineers2-0.1.0-beta.1-win-x64.zip
   python scripts/kontrol_adapters.py verify-package --package artifacts/kontrol-adapter-spaceengineers2-0.1.0-beta.1-win-x64.zip
   Get-FileHash artifacts/kontrol-adapter-spaceengineers2-0.1.0-beta.1-win-x64.zip -Algorithm SHA256
   ```
